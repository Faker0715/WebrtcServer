//
// Created by faker on 23-4-3.
//

#ifndef XRTCSERVER_CODEC_INFO_H
#define XRTCSERVER_CODEC_INFO_H
...
namespace xrtc {
    ...
    class CodecInfo {
    public:
        virtual AudioCodecInfo* as_audio() {
            return nullptr;
        }
        virtual VideoCodecInfo* as_video() {
            return nullptr;
        }
    public:
        int id;
    ...
    public:
        AudioCodecInfo* as_audio() override {
            return this;
        }
    public:
        int channels;
    ...
    public:
        VideoCodecInfo* as_video() override {
            return this;
        }
    };
}
